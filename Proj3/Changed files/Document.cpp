...
void Document::dispatchUnloadEvents()
{
    ...
    if (m_loadEventProgress >= LoadEventTried && m_loadEventProgress <= UnloadEventInProgress) {
	    ...
	    __android_log_write(ANDROID_LOG_VERBOSE, "Proj3", "Detected unload event; dispatching appropriate event");
...
{
  __android_log_write(ANDROID_LOG_VERBOSE, "Proj3", "Detected scroll event; queueing up event handler");
