...
class TouchPoint {
    ...
    // Instrumented code to store a hashmap of touch event types
    private static HashMap<Integer, String> touchEventMap;
	...
	// Get event type and dump it in the log
	if (touchEventMap.containsKey(defaultState)) 
	    Log.v("Proj3", "Received motion event action: " 
		  + touchEventMap.get(defaultState));
	else
	    Log.e("Proj3", "Could not detect touch event type!!");
	...
	touchEventMap = new HashMap<Integer, String>();
	touchEventMap.put(TOUCH_POINT_STATE_UNDEFINED, "TOUCH_POINT_STATE_UNDEFINED");
	touchEventMap.put(TOUCH_POINT_STATE_RELEASED, "TOUCH_POINT_STATE_RELEASED");
	touchEventMap.put(TOUCH_POINT_STATE_PRESSED, "TOUCH_POINT_STATE_PRESSED");
	touchEventMap.put(TOUCH_POINT_STATE_MOVED, "TOUCH_POINT_STATE_MOVED");
	touchEventMap.put(TOUCH_POINT_STATE_STATIONARY, "TOUCH_POINT_STATE_STATIONARY");
	touchEventMap.put(TOUCH_POINT_STATE_CANCELLED, "TOUCH_POINT_STATE_CANCELLED");
