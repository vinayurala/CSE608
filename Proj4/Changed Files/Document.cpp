...
void Document::dispatchUnloadEvents()
{
    ...
    if (m_loadEventProgress >= LoadEventTried && m_loadEventProgress <= UnloadEventInProgress) {
	    ...
	    ri_obj.dispatch_message("verbose", "onUnload", "Detected unload event; dispatching appropriate event");
...
{
  render_instrumenter ri_obj;
  ri_obj.dispatch_message("verbose", "onScroll", "Detected scroll event; queueing up event handler");
